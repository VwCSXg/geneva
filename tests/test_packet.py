...
def test_restrict_fields(logger):
    ...
    assert layers.tcp_layer.TCPLayer in geneva.layers.packet.SUPPORTED_LAYERS
    assert layers.udp_layer.UDPLayer in geneva.layers.packet.SUPPORTED_LAYERS
    assert not layers.ip_layer.IPLayer in geneva.layers.packet.SUPPORTED_LAYERS
    ...
    assert layers.tcp_layer.TCPLayer in geneva.layers.packet.SUPPORTED_LAYERS
    assert not layers.udp_layer.UDPLayer in geneva.layers.packet.SUPPORTED_LAYERS
    assert not layers.ip_layer.IPLayer in geneva.layers.packet.SUPPORTED_LAYERS
    ...
    assert layers.tcp_layer.TCPLayer in geneva.layers.packet.SUPPORTED_LAYERS
    assert not layers.udp_layer.UDPLayer in geneva.layers.packet.SUPPORTED_LAYERS
    assert layers.ip_layer.IPLayer in geneva.layers.packet.SUPPORTED_LAYERS
    ...
    assert len(geneva.layers.packet.SUPPORTED_LAYERS) == 2
    assert not layers.tcp_layer.TCPLayer in geneva.layers.packet.SUPPORTED_LAYERS
    assert layers.udp_layer.UDPLayer in geneva.layers.packet.SUPPORTED_LAYERS
    assert layers.ip_layer.IPLayer in geneva.layers.packet.SUPPORTED_LAYERS

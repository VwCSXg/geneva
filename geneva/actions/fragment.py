...
class FragmentAction(Action):
    ...
    def ip_fragment(self, packet, logger):
        ...
        packet1 = geneva.layers.packet.Packet(frags[0])
        packet2 = geneva.layers.packet.Packet(frags[1])
    ...
    def tcp_segment(self, packet, logger):
        ...
        packet1 = geneva.layers.packet.Packet(pkt1)
        packet2 = geneva.layers.packet.Packet(pkt2)
